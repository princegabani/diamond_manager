...
const TABLE_HEAD = [
    ...
    { id: 'salaryType', label: 'Type', alignRight: false },
    { id: 'isPaid', label: 'Paid this month', alignRight: false },
    { id: 'isEmployed', label: 'Status', alignRight: false },
    { id: '' },
];
...
const WIDGETS = [
    { id: 'Salary', title: "Salary", total: 714000, color: "primary" },
    { id: 'Sell', title: "Sell", total: 1352831, color: "info" },
    { id: 'Expenses', title: "Expenses", total: 1723315, color: "warning" },
    { id: 'Outside', title: "Outside", total: 234, color: "error" },
]
// ----------------------------------------------------------------------
...
export default function FinancePage() {
    ...
    const getEmpployeeList = async () => {
        ...
        if (getData) setEmployeeList(getData)
    ...
    return (
        <>
            <Helmet>
                <title> Finance | {account?.companyName} </title>
            </Helmet>
            ...
            <Container>
                ...
                <Grid container spacing={3} mb={5}>
                    {WIDGETS.map((data, i) => {
                        return (
                            <Grid key={i} index={i} item xs={12} sm={6} md={3} onClick={() => handleOnClickCategory(data.title)}>
